...
<main class="container">
    <article class="">
        <div>
            ...
            <form>
                <input type="text" id="name" name="name" placeholder="Nome" aria-label="Nome" autocomplete="name"
                       required>
                <input type="text" id="surname" name="surname" placeholder="Cognome" aria-label="Cognome"
                       autocomplete="surname" required>
                <input type="email" id="email" name="email" placeholder="Indirizzo Email" aria-label="Email"
